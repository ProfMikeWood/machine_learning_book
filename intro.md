...
```{note}
This book is a work in progress and will continue to be updated through Spring 2026 and beyond. If you have any feedback or constructive suggestions, feel free to submit an issue on the [Github repository](https://github.com/ProfMikeWood/machine_learning_book) for this book. I appreciate your feedback!
```
